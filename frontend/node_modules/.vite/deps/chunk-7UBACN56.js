import {
  Typography_default
} from "./chunk-XU2JD3Z3.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-GDGBM5H6.js";
import {
  useTheme
} from "./chunk-TLFR5P3C.js";
import {
  HTMLElementType,
  _extends,
  chainPropTypes,
...
var useChartDimensions = (width, height, margin) => {
  ...
  const drawingArea = React7.useMemo(() => ({
...
var DrawingContext = React8.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React8.createContext({
  isInitialized: false,
  data: {
    current: null
  }
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const isPointInside = React8.useCallback(({
    x: x2,
    y: y2
  }, options) => {
  ...
  const value = React8.useMemo(() => _extends({
    chartId: chartId ?? ""
  }, drawingArea, {
    isPointInside
  }), [chartId, drawingArea, isPointInside]);
  const refValue = React8.useMemo(() => ({
    isInitialized: true,
    data: svgRef
  }), [svgRef]);
...
function usePieSeries() {
  ...
  return React19.useMemo(() => series.pie, [series.pie]);
}
function useBarSeries() {
  const series = useSeries();
  return React19.useMemo(() => series.bar, [series.bar]);
}
...
function CartesianProvider(props) {
  ...
  const xValues = React25.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React25.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
function HighlightedProvider({
  ...
  return (0, import_jsx_runtime9.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
var InteractionContext = React30.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React30.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  return (0, import_jsx_runtime11.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
var AnimationContext = React35.createContext({
  isInitialized: false,
  data: {
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime14.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime14.jsxs)(React40.Fragment, {
...
function useChartGradient() {
  ...
  return React42.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React43.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React43.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var ChartContainer = React45.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime17.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime17.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime17.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime17.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime17.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime17.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime17.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime17.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime17.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
var ResponsiveChartContainer = React47.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime18.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime20.jsxs)(XAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime20.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime20.jsxs)("g", {
        ...
        children: [!disableTicks && showTick && (0, import_jsx_runtime20.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime20.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime21.jsxs)(YAxisRoot, {
...
var Portal = React53.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React53.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime34.jsxs)(React70.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime36.jsxs)(React72.Fragment, {
...
//# sourceMappingURL=chunk-7UBACN56.js.map
