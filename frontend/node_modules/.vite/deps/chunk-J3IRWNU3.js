...
function usePieSeries() {
  ...
  return React54.useMemo(() => series.pie, [series.pie]);
}
...
function useChartId() {
  ...
  return React60.useMemo(() => chartId, [chartId]);
}
...
var ZAxisContext = React61.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React61.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
  ...
  return (0, import_jsx_runtime22.jsx)(ZAxisContext.Provider, {
    value,
    children
  });
}
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React66.useMemo(() => {
  ...
  const providerValue = React66.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react16.forwardRef)((givenProps, givenRef) => {
    ...
    return React67.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React68.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React68.createContext(init));
...
var AnimationContext = React69.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React71.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime24.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
var InteractionContext = React72.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React72.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React72.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
  return (0, import_jsx_runtime25.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React73.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React74.forwardRef(function ChartsSurface2(inProps, ref) {
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime27.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime27.jsxs)(React75.Fragment, {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React78.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React78.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React79.useRef(null);
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-J3IRWNU3.js.map
