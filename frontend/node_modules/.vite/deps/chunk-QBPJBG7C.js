...
function StyledEngineProvider(props) {
  ...
  const cache = React8.useMemo(() => getCache(injectFirst, enableCssLayer), [injectFirst, enableCssLayer]);
...
var useChartDimensions = (width2, height2, margin2) => {
  ...
  const drawingArea = React44.useMemo(() => ({
...
var DrawingContext = React45.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React45.createContext({
  isInitialized: false,
  data: {
    current: null
  }
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const isPointInside = React45.useCallback(({
    x: x2,
    y: y2
  }, options) => {
  ...
  const value = React45.useMemo(() => _extends({
    chartId: chartId ?? ""
  }, drawingArea, {
    isPointInside
  }), [chartId, drawingArea, isPointInside]);
  const refValue = React45.useMemo(() => ({
    isInitialized: true,
    data: svgRef
  }), [svgRef]);
...
var rgb_default = function rgbGamma(y2) {
  ...
  function rgb3(start3, end2) {
    var r = color3((start3 = rgb2(start3)).r, (end2 = rgb2(end2)).r), g = color3(start3.g, end2.g), b = color3(start3.b, end2.b), opacity = nogamma(start3.opacity, end2.opacity);
    return function(t) {
      start3.r = r(t);
      start3.g = g(t);
      start3.b = b(t);
...
function useDrawingArea() {
  const {
    ...
    right: right3,
    isPointInside
  } = React60.useContext(DrawingContext);
...
function CartesianProvider(props) {
  ...
  const xValues = React61.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React61.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
function HighlightedProvider({
  ...
  return (0, import_jsx_runtime22.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
var InteractionContext = React66.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React66.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React66.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
function useChartId() {
  ...
  return React68.useMemo(() => chartId, [chartId]);
}
...
var AnimationContext = React71.createContext({
  isInitialized: false,
  data: {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React72.useContext(AnimationContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React73.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime25.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React74.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React75.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime26.jsxs)(ChartChartsSurfaceStyles, _extends({
    width: width2,
    height: height2,
    ...
    children: [(0, import_jsx_runtime26.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime26.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime27.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime27.jsxs)(React76.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React78.useContext(DrawingContext);
  return React78.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React79.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React79.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var ChartContainer = React81.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  const stateRef = React82.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const rootRef = React82.useRef(null);
  const [width2, setWidth] = React82.useState(0);
  const [height2, setHeight] = React82.useState(0);
  const computeSize = React82.useCallback(() => {
...
var ResponsiveChartContainer = React83.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function ChartsText(props) {
  ...
  const wordsByLines = React84.useMemo(() => getWordsByLines({
    style: style4,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime35.jsxs)(React88.Fragment, {
...
var Portal = React89.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React89.useState(null);
  const handleRef = useForkRef(React89.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React89.isValidElement(children)) {
      ...
      return React89.cloneElement(children, newProps);
    }
    return children;
  }
...
var Popper3 = React94.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React96.useState(null);
  React96.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
var Typography = React99.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color3,
    ...themeProps
  } = useDefaultProps2({
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React101.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React101.useMemo(() => {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QBPJBG7C.js.map
